...
import structures$SocialMedia from './components/structures/SocialMedia';
structures$SocialMedia && (components['structures.SocialMedia'] = structures$SocialMedia);
import structures$SocialMediaChoice from './components/structures/SocialMediaChoice';
structures$SocialMediaChoice && (components['structures.SocialMediaChoice'] = structures$SocialMediaChoice);
...
structures$socialMedia$Telegram && (components['structures.socialMedia.Telegram'] = structures$socialMedia$Telegram);
import structures$socialMedia$VK from './components/structures/socialMedia/VK';
structures$socialMedia$VK && (components['structures.socialMedia.VK'] = structures$socialMedia$VK);
...
import structures$Accounts from './components/structures/Accounts';
...
import structures$DonationMenu from './components/structures/DonationMenu';
structures$DonationMenu && (components['structures.DonationMenu'] = structures$DonationMenu);
...
import structures$SocialMediaChat from './components/structures/SocialMediaChat';
structures$SocialMediaChat && (components['structures.SocialMediaChat'] = structures$SocialMediaChat);
import structures$SocialMediaLogin from './components/structures/SocialMediaLogin';
structures$SocialMediaLogin && (components['structures.SocialMediaLogin'] = structures$SocialMediaLogin);
...
import views$auth$EasyStarsSync from './components/views/auth/EasyStarsSync';
views$auth$EasyStarsSync && (components['views.auth.EasyStarsSync'] = views$auth$EasyStarsSync);
...
import views$settings$tabs$user$UserSyncSettingsTab from './components/views/settings/tabs/user/UserSyncSettingsTab';
views$settings$tabs$user$UserSyncSettingsTab && (components['views.settings.tabs.user.UserSyncSettingsTab'] = views$settings$tabs$user$UserSyncSettingsTab);
